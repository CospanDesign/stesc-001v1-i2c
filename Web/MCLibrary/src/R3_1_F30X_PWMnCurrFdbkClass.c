...
static uint16_t R3_1_F30X_ExecRegularConv_ESC(CPWMC this, uint8_t bChannel);
...
CR3_1_F30X_PWMC R3_1_F3XX_NewObject(pPWMnCurrFdbkParams_t pPWMnCurrFdbkParams, pR3_1_F30XParams_t pR3_1_F30XParams)
{
  ...
  _oPWMnCurrFdbk->Methods_str.pPWMC_ExecRegularConv_ESC= &R3_1_F30X_ExecRegularConv_ESC;
